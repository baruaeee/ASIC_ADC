...
C {devices/code_shown.sym} 340 40 0 0 {name=SPICE only_toplevel=false value=".dc Vin 0 5 0.01
.save all"
plot Vin Vout}
C {sky130_fd_pr/corner.sym} 350 -150 0 0 {name=CORNER only_toplevel=false corner=tt}
