...
# Generated on: Sun Feb 09 17:54:15 CET 2025 (Sun Feb 09 16:54:15 UTC 2025)
...
set logfile fv/thermometer/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/thermometer -revised fv_map -use_rtl_names
...
read_library -liberty -both \
    /home/cae1/Desktop/D-Design/Synthesis/lib/sky130_tt_1.8_25_nldm.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k Thermometer.v
elaborate_design -golden -root {thermometer} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/thermometer/fv_map.v.gz
elaborate_design -revised -root {thermometer}
...
set_analyze_option -mapping_file fv/thermometer/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.thermometer.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.thermometer.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.thermometer.rtl.fv_map.rpt
