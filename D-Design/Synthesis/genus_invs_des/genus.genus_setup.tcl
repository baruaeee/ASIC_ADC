...
################################################################################
if {[::legacy::find -design design:thermometer] ne ""} {
  puts "** A design with the same name is already loaded. It will be removed. **"
  delete_obj design:thermometer
}
...
# Libraries
################################################################################
::legacy::set_attribute library {/home/cae1/Desktop/D-Design/Synthesis/lib/sky130_tt_1.8_25_nldm.lib} /


# Design
################################################################################
read_netlist -top thermometer genus_invs_des/genus.v
...
# slack
set _slk_ [::legacy::get_attribute slack design:thermometer]
if {[regexp {^-?[0-9.]+$} $_slk_]} {
  set _slk_ [format %.1f $_slk_]
}
if {$_slk_ != "2.7"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 2.7,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
set _tns_ [::legacy::get_attribute tns design:thermometer]
if {[regexp {^-?[0-9.]+$} $_tns_]} {
...
unset _tns_
# cell area
set _cell_area_ [::legacy::get_attribute cell_area design:thermometer]
if {[regexp {^-?[0-9.]+$} $_cell_area_]} {
  set _cell_area_ [format %.0f $_cell_area_]
}
if {$_cell_area_ != "621"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 621,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
set _net_area_ [::legacy::get_attribute net_area design:thermometer]
