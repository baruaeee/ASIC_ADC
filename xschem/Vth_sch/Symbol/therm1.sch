...
N -610 -120 -550 -120 {
lab=p15}
C {devices/ipin.sym} -610 -400 0 0 {name=p15 lab=p1}
C {devices/opin.sym} -570 30 0 0 {name=p199 lab=b1}
...
C {devices/lab_pin.sym} -550 -400 0 1 {name=p160 lab=p[0]}
C {devices/ipin.sym} -610 -380 0 0 {name=p161 lab=p2}
C {devices/lab_pin.sym} -550 -380 0 1 {name=p162 lab=p[1]}
C {devices/ipin.sym} -610 -360 0 0 {name=p163 lab=p3}
C {devices/lab_pin.sym} -550 -360 0 1 {name=p164 lab=p[2]}
C {devices/ipin.sym} -610 -340 0 0 {name=p165 lab=p4}
C {devices/lab_pin.sym} -550 -340 0 1 {name=p166 lab=p[3]}
C {devices/ipin.sym} -610 -320 0 0 {name=p167 lab=p5}
C {devices/lab_pin.sym} -550 -320 0 1 {name=p168 lab=p[4]}
C {devices/ipin.sym} -610 -300 0 0 {name=p169 lab=p6}
C {devices/lab_pin.sym} -550 -300 0 1 {name=p170 lab=p[5]}
C {devices/ipin.sym} -610 -280 0 0 {name=p171 lab=p7}
C {devices/lab_pin.sym} -550 -280 0 1 {name=p172 lab=p[6]}
C {devices/ipin.sym} -610 -260 0 0 {name=p173 lab=p8}
C {devices/lab_pin.sym} -550 -260 0 1 {name=p174 lab=p[7]}
C {devices/ipin.sym} -610 -240 0 0 {name=p175 lab=p9}
C {devices/lab_pin.sym} -550 -240 0 1 {name=p176 lab=p[8]}
C {devices/ipin.sym} -610 -220 0 0 {name=p177 lab=p10}
C {devices/lab_pin.sym} -550 -220 0 1 {name=p178 lab=p[9]}
C {devices/ipin.sym} -610 -200 0 0 {name=p179 lab=p11}
C {devices/lab_pin.sym} -550 -200 0 1 {name=p180 lab=p[10]}
C {devices/ipin.sym} -610 -180 0 0 {name=p181 lab=p12}
C {devices/lab_pin.sym} -550 -180 0 1 {name=p182 lab=p[11]}
C {devices/ipin.sym} -610 -160 0 0 {name=p183 lab=p13}
C {devices/lab_pin.sym} -550 -160 0 1 {name=p184 lab=p[12]}
C {devices/ipin.sym} -610 -140 0 0 {name=p185 lab=p14}
C {devices/lab_pin.sym} -550 -140 0 1 {name=p186 lab=p[13]}
C {devices/ipin.sym} -610 -120 0 0 {name=p187 lab=p15}
C {devices/lab_pin.sym} -550 -120 0 1 {name=p188 lab=p[14]}
C {devices/lab_pin.sym} -570 30 2 1 {name=p189 lab=b[0]}
C {devices/opin.sym} -570 60 0 0 {name=p190 lab=b2}
C {devices/lab_pin.sym} -570 60 2 1 {name=p191 lab=b[1]}
C {devices/opin.sym} -570 90 0 0 {name=p192 lab=b3}
C {devices/lab_pin.sym} -570 90 2 1 {name=p193 lab=b[2]}
C {devices/opin.sym} -570 120 0 0 {name=p194 lab=b4}
C {devices/lab_pin.sym} -570 120 2 1 {name=p195 lab=b[3]}
