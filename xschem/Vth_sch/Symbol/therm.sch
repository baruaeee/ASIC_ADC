...
C {devices/ipin.sym} -50 -60 2 1 {name=p1 lab=p[0]}
C {devices/ipin.sym} -50 -40 0 0 {name=p3 lab=p[1]}
C {devices/ipin.sym} -50 -20 0 0 {name=p5 lab=p[2]}
C {devices/ipin.sym} -50 0 0 0 {name=p6 lab=p[3]}
C {devices/ipin.sym} -50 20 0 0 {name=p7 lab=p[4]}
C {devices/ipin.sym} -50 40 0 0 {name=p8 lab=p[5]}
C {devices/ipin.sym} -50 60 0 0 {name=p9 lab=p[6]}
C {devices/ipin.sym} -50 80 0 0 {name=p10 lab=p[7]}
C {devices/ipin.sym} -50 100 0 0 {name=p11 lab=p[8]}
C {devices/ipin.sym} -50 120 0 0 {name=p12 lab=p[9]}
C {devices/ipin.sym} -50 140 0 0 {name=p13 lab=p[10]}
C {devices/ipin.sym} -50 160 0 0 {name=p15 lab=p[11]}
C {devices/ipin.sym} -50 180 0 0 {name=p160 lab=p[12]}
C {devices/ipin.sym} -50 200 0 0 {name=p162 lab=p[13]}
C {devices/ipin.sym} -50 220 0 0 {name=p175 lab=p[14]}
