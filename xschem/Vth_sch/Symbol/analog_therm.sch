...
C {devices/lab_pin.sym} 280 400 0 1 {name=p134 lab=b0}
...
C {devices/lab_pin.sym} -50 0 0 1 {name=p6 lab=p3}
C {devices/lab_pin.sym} -50 20 0 1 {name=p7 lab=p4}
C {devices/lab_pin.sym} -50 40 0 1 {name=p8 lab=p5}
C {devices/lab_pin.sym} -50 60 0 1 {name=p9 lab=p6}
C {devices/lab_pin.sym} -50 80 0 1 {name=p10 lab=p7}
C {devices/lab_pin.sym} -50 100 0 1 {name=p11 lab=p8}
C {devices/lab_pin.sym} -50 120 0 1 {name=p12 lab=p9}
C {devices/lab_pin.sym} -50 140 0 1 {name=p13 lab=p10}
C {devices/lab_pin.sym} -50 160 0 1 {name=p15 lab=p11}
C {devices/lab_pin.sym} -50 180 0 1 {name=p160 lab=p12}
C {devices/lab_pin.sym} -50 200 0 1 {name=p162 lab=p13}
C {devices/lab_pin.sym} -50 220 0 1 {name=p175 lab=p14}
C {devices/opin.sym} 1580 40 0 0 {name=p4 lab=b1}
C {devices/opin.sym} 1580 80 0 0 {name=p176 lab=b2 }
C {devices/opin.sym} 1580 120 0 0 {name=p177 lab=b3}
C {devices/iopin.sym} -50 -80 0 0 {name=p178 lab=Vp}
C {devices/iopin.sym} -50 240 0 0 {name=p179 lab=Vn}
C {devices/code_shown.sym} -200 340 0 0 {name=SPICE only_toplevel=false value="
vvpwr vpwr 0 dc 1.8
vvgnd vgnd 0 dc 0
"}
