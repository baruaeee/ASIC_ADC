...
C {devices/code_shown.sym} -320 -170 0 0 {name=SPICE only_toplevel=false value="
.dc Vin 0 1.8 0.01
.control
run
...
C {devices/ipin.sym} -40 20 0 0 {name=p3 lab=Vin}
C {/home/exotic/Desktop/ASIC_ADC/xschem/Vth_sch/Symbol/preamp.sym} 110 40 0 0 {name=x2}
C {devices/gnd.sym} -220 100 0 0 {name=l7 lab=GND}
C {devices/gnd.sym} -330 80 0 0 {name=l9 lab=GND}
C {devices/gnd.sym} -450 80 0 0 {name=l10 lab=GND}
