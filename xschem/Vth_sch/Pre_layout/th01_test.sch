...
N -330 100 -220 100 {
lab=GND}
C {devices/code.sym} -470 -160 0 0 {name=TT_MODEL only_toplevel=false value="
...
C {devices/code_shown.sym} -370 -260 0 0 {name=SPICE only_toplevel=false value="
.dc Vin 0 1.8 0.01
*.tran 1n 30n
.control
run
...
C {devices/opin.sym} 240 -50 0 0 {name=p2 lab=Vout}
C {devices/vdd.sym} 240 -70 0 0 {name=l2 lab=VDD}
C {devices/gnd.sym} 240 -30 0 0 {name=l4 lab=GND}
C {devices/ipin.sym} -60 -70 0 0 {name=p3 lab=Vin}
C {/home/exotic/Desktop/ASIC_ADC/xschem/Vth_sch/Symbol/op-amp.sym} 90 -50 0 0 {name=x1}
