...
C {devices/lab_pin.sym} 720 -220 2 1 {name=p46 lab=p4}
C {devices/lab_pin.sym} 720 -180 2 1 {name=p47 lab=p6}
C {devices/lab_pin.sym} 720 -140 2 1 {name=p48 lab=p8}
C {devices/lab_pin.sym} 720 -100 2 1 {name=p49 lab=p9}
...
C {devices/lab_pin.sym} 1320 460 2 1 {name=p169 lab=23}
C {devices/lab_pin.sym} 1320 420 2 1 {name=p170 lab=7}
