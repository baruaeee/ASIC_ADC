...
C {devices/opin.sym} 330 10 0 0 {name=p3 lab=Vout}
C {devices/vdd.sym} 110 -80 0 0 {name=l5 lab=VDD}
...
C {devices/code_shown.sym} -220 -360 0 0 {name=SPICE only_toplevel=false value="
.dc Vin 0 1.8 0.01
*.tran 1n 30n
.control
run
...
C {sky130_fd_pr/nfet_01v8.sym} 260 -190 0 0 {name=M5
L=28.4
W=0.36
nf=1 
mult=1
