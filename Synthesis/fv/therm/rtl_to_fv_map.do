...
# Generated on: Wed Dec 11 02:27:28 CET 2024 (Wed Dec 11 01:27:28 UTC 2024)
...
set logfile fv/therm/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/therm -revised fv_map
...
read_library -liberty -both \
    /home/cae3/Desktop/ADC/ASIC_ADC/Synthesis/lib/sky130_tt_1.8_25_nldm.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k Therm.v
elaborate_design -golden -root {therm} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/therm/fv_map.v.gz
elaborate_design -revised -root {therm}
...
#add_name_alias fv/therm/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.therm.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.therm.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.therm.rtl.fv_map.rpt
