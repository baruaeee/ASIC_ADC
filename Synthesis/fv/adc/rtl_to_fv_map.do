...
# Generated on: Wed Dec 11 02:35:26 CET 2024 (Wed Dec 11 01:35:26 UTC 2024)
...
set logfile fv/adc/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/adc -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ADC.v
elaborate_design -golden -root {adc} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/adc/fv_map.v.gz
elaborate_design -revised -root {adc}
...
#add_name_alias fv/adc/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.adc.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.adc.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.adc.rtl.fv_map.rpt
